...
const Upcomming = () => {
    return (
        <Container style={{ margin: '50px auto', textAlign: 'center' }}>
            ...
            <Row>
                <Col md={4} sm={12}>
                    <img style={{ width: '100%' }} src={upcoming4} alt="" />
                </Col>

                <Col md={4} sm={12}>
                    <img style={{ width: '100%' }} src={upcoming6} alt="" />
                </Col>
                <Col md={4} sm={12}>
                    <img style={{ width: '100%' }} src={upcoming1} alt="" />
                </Col>
                <Col md={4} sm={12}>
                    <img style={{ width: '100%' }} src={upcoming2} alt="" />
                </Col>
                <Col md={4} sm={12}>
                    <img style={{ width: '100%' }} src={upcoming3} alt="" />
                </Col>
                <Col md={4} sm={12}>
                    <img style={{ width: '100%' }} src={upcoming5} alt="" />
                </Col>
