...
const MyOrders = () => {
    ...
    return (
        <>
            ...
            {!loading ? <Table responsive style={{ marginTop: '20px' }} striped bordered hover>
                <thead>
                    <tr>
                ...
                <tbody>
                    {
                        myorders?.map(myorder => <tr key={myorder._id}>
                            ...
                            <td className="text-center" style={{ fontSize: '22px' }}>{myorder?.fullName}</td>
                            <td className="text-center" style={{ fontSize: '22px' }}>{myorder?.productName}</td>
                            <td className="text-center" style={{ fontSize: '22px' }}>{myorder?.status}</td>
                            <td className="text-center" style={{ fontSize: '22px' }}><button
